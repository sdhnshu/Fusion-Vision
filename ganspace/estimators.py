...
class ICAEstimator():
    def __init__(self, n_components):
        ...
        self.transformer = FastICA(n_components, random_state=0,
                                   whiten=self.whiten, max_iter=self.maxiter)
    ...
    def fit(self, X):
        ...
        self.transformer.components_ /= np.sqrt(
            np.sum(self.transformer.components_**2, axis=-1, keepdims=True))
